from typing import List, Reversible, Tuple, TYPE_CHECKING
import textwrap
...
class MessageLog:
    ...
    def add_message(
        ...
        `text` is the message text, `fg` is foreground color.
    ...
    def render_messages(
        ...
        The `messages` are rendered starting at the lsat message and working backwards.
        """
        y_offset = height - 1
